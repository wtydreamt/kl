				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						<li>
							...
							<a href="<?php echo U('Home/Category/addv');?>">添加观点分类</a>
						</li>
					</ul><!-- /.breadcrumb -->
					...
					<div class="nav-search" id="nav-search">
						<form class="form-search">
							<span class="input-icon">
								<a href="<?php echo U('Home/Category/viewpoint');?>" class="nav-search-input">观点分类</a>
							</span>
						</form>
					</div><!-- /.nav-search -->
							...
							<div class="col-xs-12">
								...
								<div class="row center">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="form-field-1" placeholder="分类名称" class="col-xs-10 col-sm-5" />
										</div>
									</div>
...
<script type="text/javascript" src='/gitkunl/kl/kuluncom/Public/assets/js/jquery.min.js'></script>
		<script type="text/javascript">
			$("[type='button']").click(function(){
				var url="<?php echo U('Home/Category/addv');?>";
