		...
		<div class="mooc_peg_lt float_left" style="width: 100%;">
		    ...
		    <div class="mooc_peg_tank">
				<dl class="mooc_peg_tank_dl clear">
		            <dt>讲 师：</dt><dd class="current"><a href="<?php echo U('Curriculum/index');?>" ck="vip_course_list_q_讲 师不限" refkc="vip_course_list_q_讲 师不限">不限</a></dd>
		            <?php if(is_array($uinfo)): foreach($uinfo as $key=>$u): ?><dd><a href="<?php echo U('Curriculum/index');?>?uid=<?php echo ($u["u_id"]); ?>" ><?php echo ($u["nickname"]); ?></a></dd><?php endforeach; endif; ?>
		            </dl>
			</div>
		    </div>
		</div><!--mooc_peg_lt end-->
