    ...
    <div class="klBannerConTwo">
	    ...
	    <div class="kl_lia_con">
	    	<div class="lia0n1" style="display: block;">
              <div class="box1502">
                <p><strong>实盘大赛：</strong></p>
                <p>上海证券·优品投资杯凤凰实盘炒股大赛是由凤凰财经事业部与优品投资联合举办上海证券协办的A股投资比赛。参赛选手需是凤凰网用户，且在上海证券开立证券账户方可完成报名。大赛旨在挖掘民间“草根”操盘高手，为其提供一个展现自我风采、相互学习的大舞台。</p>
                <p style="padding-top:10px;"><strong>赛制：</strong>分为日赛、周赛、月赛和总决赛，所有比赛按照自然周、自然月统计排名，天天都有比赛，月月都有奖。具体奖金金额请参见“奖项设置”。</p>
                <p style="padding-top:10px;"><strong>报名规则：</strong>选手进入实盘赛，需要满足以下条件</p>
                <p>1、年满18周岁，具备独立的民事责任承担能力；</p>
                <p>2、与主办方或主办方指定的代理方签订实盘资金操作协议；</p>
                <p>3、不存在证券市场禁入情况；</p>
				<p>4、上海证券用户可以直接报名参加比赛，非上海证券用户需要通过凤凰网，或直接在上海证券开户后方可参赛。</p>
				<p>5、参赛没有资金限额，但资产量在1万以上才能进入排行榜，才具有领奖资格。</p>
				<p>如果出现选手无法获得有效联系、或者不满足实盘赛参与条件的，主办方不另作补偿，将从其他选手中依次选取；</p>
				
                <p style="padding-top:40px;"><strong>模拟盘</strong></p>
                <p style="padding-top:10px;"><strong>赛事介绍：</strong>凤凰炒股大赛是由凤凰网财经事业部与优品财富联合举办的A股投资比赛。只要是凤凰的注册用户就可以参加。大赛旨在挖掘民间"草根"操盘高手，为其提供一个展现自我风采、相互学习的大舞台。</p>
                <p style="padding-top:10px;"><strong>赛制：</strong></p>
                <p><strong>日赛：</strong>每个交易日都有比赛，日冠军奖励100积分。</p>
                <p><strong>周赛：</strong>所有选手一起参与，按自然周的周收益进行排名。</p>
                <p><strong>月赛：</strong></p>
                <p><strong>海选赛：</strong>6月1日，海选赛正式开赛，所有参赛选手群英汇，一起比拼。海选赛前1000名将升级进入7月精英赛。月末最后一个交易日盘后清算完成后所有选手持股将被强行平仓，总收益率和总资金保留。</p>
                <p><strong>精英赛&amp;挑战赛：</strong>7月：周赛维持不变；月赛将分为两个赛事：精英赛和挑战赛。6月海选赛的前1000名将可以参加精英赛，其余选手和新报名的选手参加挑战赛。月末最后一个交易日清算完成后所有选手持股同样将被强行平仓，送收益率和总资金保留。精英赛后600名降入挑战赛，挑战赛前600名升入精英赛。</p>
                <p>8月、9月、10月升降级和平仓规则与7月相同，10月新报名用户只能参加挑战赛。</p>
                <p style="padding-top:10px;"><strong>报名规则：</strong></p>
                <p>1、凤凰网用户可以直接登录交易平台；非凤凰网用户可以快速注册凤凰网账号；用户还可以使用第三方账号登录，我们提供QQ和微博等第三方登录方式。</p>
                <p>2、用户进入模拟大赛平台后，需要进行手机号验证才能正式参加比赛，大赛官方也将以注册手机号作为发奖依据。
			  </p></div>
          </div>
          <div class="lia0n1">
             <img src="http://p0.ifengimg.com/a/2017_01/737f0291c916f6a_size352_w900_h2037.jpg">
          </div>
