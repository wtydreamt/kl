...
" />
    <link rel="shortcut icon" href="/gitkunl/kl/kuluncom/webapp/Public/index/images/ybtx_favicon.ico" />
    ...
    <!-- zui -->
    <link href="/gitkunl/kl/kuluncom/webapp/Public/index/css/zui.css" rel="stylesheet">
    <link rel="stylesheet" href="/gitkunl/kl/kuluncom/webapp/Public/index/css/kui.css">
</head>
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand " href="your/nice/url">
                            <img src="/gitkunl/kl/kuluncom/webapp/Public/index/images/logo.png" alt="" class="kllogo">
                        </a>
                    </div>
                    <!-- 导航项目 -->
  ...
  <?php if(is_array($banner)): foreach($banner as $key=>$val): ?><div class="item">
     <a href="/">
     	 <img alt="First slide" src="/gitkunl/kl/kuluncom/webapp/<?php echo ($val["banner_img"]); ?>" style="width: 100%; max-height: 430px;">
     </a>
  ...
  <a class="right carousel-control" href="#myNiceCarousel" data-slide="next">
    ...
    <div class="container klcontainer">
        ...
        <ul class="zb-list-ul">
            ...
            <li class="bner-con">
            	<div class="col-xs-6">
            		<a href="/Index/Teacher/details.html"><img src="/gitkunl/kl/kuluncom/webapp/<?php echo ($chief["1"]["cover_img"]); ?>" class="hover_optin"></a>
            	</div>
            	<div class="col-xs-3">
            		<p>	
            			<a href="/Index/Teacher/details.html"><img class="hover_optin" src="/gitkunl/kl/kuluncom/webapp/<?php echo ($chief["2"]["0"]["cover_img"]); ?>"></a>
            		</p>
            		<p>
            			<a href="/Index/Teacher/details.html"><img class="hover_optin" src="/gitkunl/kl/kuluncom/webapp/<?php echo ($chief["2"]["1"]["cover_img"]); ?>"></a>
            		</p>
            	</div>
            	<div class="col-xs-3">
            			<a href="/Index/Teacher/details.html">
            				<img src="/gitkunl/kl/kuluncom/webapp/<?php echo ($chief["3"]["cover_img"]); ?>" class="hover_optin" >
            			</a>
            	</div>
            </li>
        </ul>
          ...
          <?php if(is_array($content)): foreach($content as $key=>$con): ?><li>
          	...
          	<div class="zt_sb">
          		...
          		<a href="/">
          			<img src="/gitkunl/kl/kuluncom/webapp/<?php echo ($con["head_img"]); ?>" alt="" style="width: 30px;">
        ...
        <p class="klts text-center">
            <img src="/gitkunl/kl/kuluncom/webapp/Public/index/images/bx.png" alt=""> 想看更多的请点击我们的公众号！
        </p>
    </div>
        ...
        <div class="bg-grayq">
            <div class="container pb-36">
                ...
                <div class="col-lg-4">
                    ...
                    <img class="ewm center-block  with-padding" src="/gitkunl/kl/kuluncom/webapp/Public/index/images/ewm.jpg" alt="昆仑财富-公众号">
                </div>
            </div>
        </div>
        <div class="bg-grays">
...
<div class="sb_gzh">
	<h5>扫一扫关注公众号</h5>
	<img src="/gitkunl/kl/kuluncom/webapp/Public/index/images/ewm.jpg"/>
</div>
    <script src="/gitkunl/kl/kuluncom/webapp/Public/index/js/jquery-1.11.0.min.js"></script>
    <script src="/gitkunl/kl/kuluncom/webapp/Public/index/js/zui.min.js"></script>
    <script>
